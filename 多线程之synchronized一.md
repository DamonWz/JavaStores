...
[反编译](http://mp.weixin.qq.com/s?__biz=MzI3NzE0NjcwMg==&mid=402199167&idx=1&sn=f6597f81f7e961cfbc49b06085e8c2a5&scene=21#wechat_redirect)后，我们可以看到Java编译器为我们生成的字节码。在对于`doSth`和`doSth1`的处理上稍有不同。也就是说。JVM对于同步方法和同步代码块的处理方式不同。
